...
public class EncryptImage1 extends HttpServlet
{
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
	{
		...
		try 
		{
			System.out.println("Start VC Process");
			//if(submi.trim().equals("VC Process"))
			//{
 	           ...
 	           if(flag)
 				{
 					...
 					ArrayList<String> list1 =ImageInputDetails.runProg(filepath, 0,outFilePath,outFilePath);
