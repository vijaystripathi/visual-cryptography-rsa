...
public class ComposeMail extends HttpServlet
{
	...
	private static  String fromEmailId="vcursa@gmail.com";
	private static  String password="yoyo12345";
		...
		try 
		{
			...
			if(flag)
			{
				...
				if(flag)
				{
					...
					rd = getServletContext().getRequestDispatcher("/JSP/User/cancel.jsp?no=1");
					rd.forward(request, response);
				}
				else
				{
					System.out.println("Opps,Something Went Wrong While Sending The Mail!!!!");
					rd=request.getRequestDispatcher("/JSP/User/compose_mail.jsp?no1=1");
					rd.forward(request, response);
				}
