	...
	<div id="a1" style="position: absolute;top: 30px;left: 200px;">
	 ...
	 <table id="login" align="center">
			     	...
			     	<tr>
			     		...
			     		<td>:</td>
			     		<td>
			     			<input class="field" type="password" name="pass" requied="yes"></input>
			     		</td>
			     	</tr>
			     	<tr><td>&nbsp;</td></tr>
			     	...
			     	<tr>
			     		...
			     		<td>:</td>
			     		<td>
			     			<input class="field" type="password" name="npass"  requied="yes"></input>
			     		</td>
			     	</tr>
			     	<tr><td>&nbsp;</td></tr>
			     	...
			     	<tr>
			     		...
			     		<td>:</td>
			     		<td><input class="field" type="password" name="cpass"  requied="yes"></input></td>
			     	</tr>
			     	<tr><td>&nbsp;</td></tr>
			     	<tr>
